@extends('layouts.main', ['activePage' =>'inventory'], ['tittle' => $medicamento->nombreMedicamento])
@section('content')
    ...
    <div class="main-content">
        <div class="page-header no-gutters">
            <div class="row justify-content-between align-items-md-center">
                <div class="col-md-6">
                    <h2 class="header-title">{{$medicamento->nombreMedicamento}}</h2>
                    <div class="header-sub-title">
                        <nav class="breadcrumb breadcrumb-dash">
                            <a href="#" class="breadcrumb-item"><i class="text-success anticon anticon-home m-r-5"></i>Inicio</a>
                            <a class="breadcrumb-item" href="#"><i class="text-success anticon anticon-shop m-r-5"></i>Tienda</a>
