...
<html lang="es">
  ...
  <body style="background-image: url({{asset('login-assets/img/recuperarcontraseña.jpg')}});">
  <div class="content">
    <div class="container">
            ...
            <div class="col-md-12">
              <div class="form-block">
                  <div class="">
                    ...
                    @endif
                    <h3 class="text-center mb-5"><img src="{{asset('login-assets/img/logo.png')}}" alt=""></h3>
