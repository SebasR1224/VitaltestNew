                                        ...
                                        @foreach ($categories as $category)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    @can('category_edit')
                                                        <button type="button"  data-toggle="modal" data-target="#editCategory{{$category->id}}" style="font-size: 17px"  class="btn btn-icon btn-hover text-warning btn-sm btn-rounded pull-right" data-toggle="tooltip" data-placement="left" title="Editar categoria">
                                    ...
                                    <tbody>
                                        @foreach ($laboratories as $laboratory)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    @can('laboratory_edit')
                                                        <button type="button"  style="font-size: 17px" data-toggle="modal" data-target="#editLaboratory{{$laboratory->id}}" class="btn btn-icon btn-hover text-warning btn-sm btn-rounded pull-right" data-toggle="tooltip" data-placement="left" title="Editar laboratorio">
                                                            <i class="anticon anticon-edit"></i>
                                                        </button>
